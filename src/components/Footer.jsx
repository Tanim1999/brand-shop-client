...
const Footer = () => {
    return (
        <div>
            <footer className="footer p-10 bg-[#800000] text-white">
                <nav>
            ...
            <footer className="footer px-10 py-4 border-t bg-[#800000] text-white border-base-300">
                <aside className="items-center grid-flow-col">
                    ...
                    <p>Gadget Hub. <br />Providing reliable tech since 1992</p>
                </aside>
